...
* **api:** add people merge endpoint ([49d6e14](https://github.com/gumnut-ai/photos-cli/commit/49d6e1408ab19e2aa41aa6e1a2ebb5c07490a3d8))
* **api:** api update ([e4ae1ba](https://github.com/gumnut-ai/photos-cli/commit/e4ae1baf279483532ab3b253f92003bfa3d4ef59))
* **api:** api update ([967d051](https://github.com/gumnut-ai/photos-cli/commit/967d051a0bbd60530454103b3dd261598d0dc1ae))
* **api:** api update ([5966dfd](https://github.com/gumnut-ai/photos-cli/commit/5966dfd29f64c717813c99939791151c0494ff7e))
* **api:** api update ([8b2999a](https://github.com/gumnut-ai/photos-cli/commit/8b2999a8b19fc21019e9e33dec3dc5e4f3bfab81))
* **api:** api update ([739ec1c](https://github.com/gumnut-ai/photos-cli/commit/739ec1c4068b8c9117864afe151da5e311702c96))
* **api:** api update ([c1e8818](https://github.com/gumnut-ai/photos-cli/commit/c1e8818d0c1547840c333777cc7ea68d5335f934))
* **api:** api update ([d9ce319](https://github.com/gumnut-ai/photos-cli/commit/d9ce3195c889cd6eefa755d02b9536b70b5c6683))
* **api:** api update ([d4de94d](https://github.com/gumnut-ai/photos-cli/commit/d4de94d8b5d48cd3ea3f95049540d6c9f5881cfe))
* **api:** api update ([b54da6f](https://github.com/gumnut-ai/photos-cli/commit/b54da6f62ae1fcf29b94253b0a1f00c0ef50246b))
* **api:** api update ([34d81b7](https://github.com/gumnut-ai/photos-cli/commit/34d81b76d9996f8108e3736b18c55ab1bb78c144))
* **api:** api update ([a8b98ff](https://github.com/gumnut-ai/photos-cli/commit/a8b98ff39ad22ccf001afd7e9ce59648a058e18c))
* **api:** api update ([ad659a2](https://github.com/gumnut-ai/photos-cli/commit/ad659a2295b862d91e7dcb35a5f85a999da0eb1e))
* **api:** api update ([0cd864d](https://github.com/gumnut-ai/photos-cli/commit/0cd864d2313a54ba577da008a64bb599d98057ec))
* **api:** api update ([d77c1fd](https://github.com/gumnut-ai/photos-cli/commit/d77c1fd298a0d8e8e69f798c39638c482e25066c))
* **api:** api update ([4ba61d5](https://github.com/gumnut-ai/photos-cli/commit/4ba61d5cd361533c8baa51718a1d27d858aeb9f9))
* **api:** api update ([9f2377b](https://github.com/gumnut-ai/photos-cli/commit/9f2377b5e929768cf69620a93cfcac4a4c30d2cf))
...
* **api:** Gumnut ([a3f8127](https://github.com/gumnut-ai/photos-cli/commit/a3f81272a807ee608650de697e8d5fe09ff6f571))
* **api:** library trash/restore endpoints ([c6c69f7](https://github.com/gumnut-ai/photos-cli/commit/c6c69f7e5f9c56cba0f1997397c7b3485717a990))
* **api:** manual updates ([ab6e7e2](https://github.com/gumnut-ai/photos-cli/commit/ab6e7e291f12e39208baa6ded3e4f99702b310ec))
* **api:** manual updates ([63709bb](https://github.com/gumnut-ai/photos-cli/commit/63709bbb5b4fd46322f1d691dd906df9361b14ee))
* **api:** more apis ([8e22d25](https://github.com/gumnut-ai/photos-cli/commit/8e22d25cdd499a5514e9517eba3e1f68d56074c3))
* **api:** update api keys endpoints ([8d547af](https://github.com/gumnut-ai/photos-cli/commit/8d547af63d6ec42c79c3a447f3b5a90747e9ae3a))
* **api:** update docs url ([dc48019](https://github.com/gumnut-ai/photos-cli/commit/dc480194dd832fa67ba885c86da30d543e97f0a1))
...
* support passing path and query params over stdin ([9135035](https://github.com/gumnut-ai/photos-cli/commit/913503582cafb60bc701444b1cc002e29235c1d3))
...
* **cli:** correctly load zsh autocompletion ([d76addd](https://github.com/gumnut-ai/photos-cli/commit/d76addd05f6f69b689ec52d729fda233e98d4095))
...
* flags for nullable body scalar fields are strictly typed ([29a7b20](https://github.com/gumnut-ai/photos-cli/commit/29a7b205643b9e2db11ed1e894b439fc85bcb4e2))
...
* **internal:** more robust bootstrap script ([efdd91c](https://github.com/gumnut-ai/photos-cli/commit/efdd91c6bc18972cabc94f7dca34c74a149dc391))
...
* redact api-key headers in debug logs ([1e5e4f2](https://github.com/gumnut-ai/photos-cli/commit/1e5e4f277a94cca5d5d86b1677a7aac4282d8a41))
